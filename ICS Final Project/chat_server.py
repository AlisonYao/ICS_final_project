...
# ==============================================================================
                ...
                new = '(' + from_name + ')' + ctime + ' ' + message
                self.indices[from_name].add_msg_and_index(new)
                # ---- end of your code --- #
                ...
                for g in the_guys:
                    ...
                    # IMPLEMENTATION
                    # ---- start your code ---- #
                    self.indices[g].add_msg_and_index(new)
                    
                    mysend(to_sock, json.dumps(
                            {"action": "exchange", "from": from_name, "message":str(ctime) + '\n' + message + '\n'}))
...
# ==============================================================================
                ...
                #print(msg)
                poem = ''
                poem1 = self.sonnet.get_poem(int(msg["target"]))
                for i in poem1:
                    poem += (i + '\n')
...
# ==============================================================================
                ...
                from_name = self.logged_sock2name[from_sock]
                search_rslt1 = self.indices[from_name].search(msg["target"])
                search_rslt = []
                for i in search_rslt1:
                    if i[1] not in search_rslt:
